...
PH=30;
I=12; %integral gain for discrete integrator

%PH=50 ma anche 30, I=12, Q=1, r=1 for ex 1
...
figure
    ...
    ylim([30 50])
    legend(h,{'ref','output'})
    title('Focus on disturbance rejection - Task 4.1')
